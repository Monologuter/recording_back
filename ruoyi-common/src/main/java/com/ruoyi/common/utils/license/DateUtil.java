...
/**
 * 日期时间工具类 Created by wangfan on 2017-6-10 上午10:10
 */
public class DateUtil {
	...
	/**
	 * 将从1970到现在的毫秒数转换为具体的日期时间?
	 * 
	 * @param time
	 * @return
	 */
	public static String longTimeMillisToDateTimeFullDatePattern(Long time) {
		SimpleDateFormat sdf = new SimpleDateFormat(FullDatePattern);
	...
	/**
	 * 获取指定date时间的转换为指定格式的时间
	 * 
	 * @project_name utils
	 * @enclosing_method parseDateToStr
	 * @return_type String
	 * @author lbp
	 * @date 2020年8月12日 下午3:18:29
	 * @param format
	 * @param date
	 * @return
	 */
	...
	public static int compare_date(String DATE1, String DATE2) {
		DATE1 = DATE1.substring(0, 10) + " 23:59:59";
